...
def _(A, B, C, np, stats):
    ...
    permutations = [np.random.permutation(total_sample) for _ in range(0,n_resamples)]
...
def _(mo):
    ...
    Imagina ara que en comptes de 24 mostres, les mateixes 8 persones fan el test A, B, i C. Un cop això és així, podem seguir demostrant la mateixa hipòtesi?
